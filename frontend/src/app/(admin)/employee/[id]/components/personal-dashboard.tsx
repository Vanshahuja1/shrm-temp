...
export function PersonalDashboard({ employeeInfo, attendanceRecords }: PersonalDashboardProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Attendance Timings Summary (quick view) */}
      <div className="bg-white rounded-lg shadow-sm border border-blue-200 p-4 sm:p-6">
        <div className="flex items-start justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h4 className="text-lg font-semibold text-gray-900">Attendance Timings</h4>
              <p className="text-sm text-gray-600">Quick reference for clock-in / clock-out rules</p>
            </div>
          </div>
          <a href="#" className="text-xs text-blue-600 hover:underline">View full policy</a>
        </div>

        <div className="mt-4 grid grid-cols-1 sm:grid-cols-3 gap-3">
          <div className="flex items-start space-x-3">
            <div className="text-green-700 font-semibold">✓</div>
            <div>
              <div className="text-sm font-medium text-gray-900">Clock In</div>
              <div className="text-xs text-gray-600">Before 9:00 AM — On time</div>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              <div className="text-sm font-medium text-gray-900">Late Arrival</div>
              <div className="text-xs text-gray-600">After 9:00 AM will be marked as Late</div>
            </div>
          </div>

          <div className="flex items-start space-x-3">
            <div className="text-blue-700 font-semibold">⌚</div>
            <div>
              <div className="text-sm font-medium text-gray-900">Clock Out</div>
              <div className="text-xs text-gray-600">5:00 PM (Standard working hours: 8 hours)</div>
            </div>
          </div>
        </div>

        <div className="mt-4 p-3 bg-blue-50 rounded border border-blue-100 text-sm text-gray-700">
          <strong>Penalty:</strong> Late arrivals may result in salary deductions or warnings as per company policy.
        </div>
      </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-blue-200 p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-medium">LKR {employeeInfo.salary.allowances.toLocaleString()}</span>
            </div>
            <div className="flex justify-between border-t pt-2">
              <span className="text-gray-900 font-medium">Total Salary:</span>
              <span className="font-bold text-blue-600">LKR {employeeInfo.salary.total.toLocaleString()}</span>
            </div>
